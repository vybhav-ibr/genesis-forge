...
from genesis_forge import GenesisManagedEnvironment
...
class Go2SimpleEnv(GenesisManagedEnvironment):
    """
    ...
    def __init__(
        ...
        self.target_command = torch.zeros(
            (self.num_envs, 3), device=self.device, dtype=self.float_type
        )
