...
class SphericalRaycasterManager(BaseSensorManager):
    """
    ...
    def __init__(
        ...
        angular_resolution: tuple[float, float]=None,
        angles: tuple[Sequence[float], Sequence[float]]=None,
        min_range: float = 0.0,
        ...
        # scene=env.scene
        spherical_pattern=gs.sensors.SphericalPattern(
            fov=fov,
            n_points=n_points,
